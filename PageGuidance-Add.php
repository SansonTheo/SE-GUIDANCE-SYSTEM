        ...
        <div class="main-page">
            <div class="main-window" style="padding:10px;">
                <div class="container window-content add-session-window" style="display:flex; width:90%; margin:auto; padding:0px; max-width:none;">
                    <form method="post" onsubmit="return validateForm()" action="counselingAdd.php" class="row m-0 p-0 w-100 h-100" id="session-form">
                        <input type="text" name="studentCount" id="studentCount" style="display:none;" value="-1">
                        <input type="text" name="parentCount" id="parentCount" style="display:none;" value="-1">
                        <input type="text"name="teacherCount" id="teacherCount" style="display:none;" value="-1">
                        <div class="col-md-4 m-0 p-0 d-flex flex-column">
                            <div class="guidance-add-container" style="flex:10%;">
                                <p>Counselor:</p>
                                <input type="text" style="display:none;" id="counselor-id" name="counselor-id" value="">
                                <span style="display:flex; height:50px; width:90%; margin:auto;"><input style="flex:90%; height:100%; margin:0px; background-color:white;" type="text" name="counselor" id="counselor" value="" disabled>
                            ...
                            <div class="guidance-add-container" style="flex:10%;" >
                                <p>Time:</p>
                                <input style="width:90%; height:50px" type="time" name="time" id="time" value="">
                            </div>
                            <div class="guidance-add-container" style="flex:10%;">
                                <p>Date:</p>
                                <input style="width:90%; height:50px;" type="date" name="date" id="date" value="">
                            </div>
                            <div class="guidance-add-container" style="flex:50%;">
                                <p>Information:</p>
                                <textarea style="width:90%; height:80%; margin:auto; margin-bottom:10px; resize:none;" name="session-info" id="session-info" form="session-form" placeholder="Session Information"></textarea>
                            </div>
                        </div>
                        <div class="col-md-4 m-0 p-0 d-flex flex-column">
                            ...
                            <div class="guidance-add-container" style="flex:70%;">
                                <div class="session-container" style="padding-top: 5px;">
                                    <p>Student/s</p>
                                    <div class="session-student-list" id="session-student-list">
                        ...
                        <div class="col-md-4 m-0 p-0 d-flex flex-column">
                                ...
                                <div class="session-container" style="padding-top: 5px;">
                                    ...
                                    <div class="session-student-list">
                                        <table class="session-student-table" id="teacherList">
                                            ...
                                            <tr style="display:none;" id="teacherNull" name="teacherNull">
                            ...
                            <div style="flex:5%; display:flex; align-items: center; justify-content: center; padding:5px;">
                                <a href="PageGuidance-Index.php" class="form-nav-button generic-button" type="button" style="width:80%; margin-right:5px;">
                                    Return
                                </a>
