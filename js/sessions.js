...
var teacherCount = document.getElementById('parentCount').value;
var oldCounselorId = "";
...
addTeacherButton.onclick = function URL() {
    if(teacherData[0]!="" && teacherData[1]!="" && teacherData[2]!=""){
        ...
        $('<tr style="trTeacher'+ teacherCount +'" id="' + teacherData[0] + '"><td id="' + teacherData[0] + '" style="display:none;"><input type="text" name="teacherNo' + teacherCount + '" id="teacherNo' + teacherCount + '" value="' + teacherData[0] + '"></td><td>' + teacherData[1] + '</td><td>' + teacherData[2] + '</td><td style="flex:5%;"><button type="button" id="teacherDelButton' + teacherCount + '">X</button></tr>').insertBefore(teacherNull);
