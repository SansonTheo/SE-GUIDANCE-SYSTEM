...
let modalCounselor = document.getElementById("counselorModal");
let addCounselorModal = document.getElementById("addCounselorModal");

addCounselorModal.onclick = function(){
    modalCounselor.style.display = "flex";
}
...
let closeCounselorModal = document.getElementById("closeCounselorModal");
...
window.onclick = function(event) {
    ...
    if(event.target == modalCounselor || event.target==closeCounselorModal){
